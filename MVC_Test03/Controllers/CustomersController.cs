...
namespace MVC_Test03.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            if (userID == null)
            {
                return RedirectToAction("Login", "Account"); // Nếu không có userID, chuyển tới trang đăng nhập
            }
        ...
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IDCus,NameCus,PhoneCus,EmailCus,AddressCus")] Customer customer)
        {
            if (ModelState.IsValid)
            {
