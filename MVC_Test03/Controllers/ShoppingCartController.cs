    ...
    public class ShoppingCartController : Controller
    {
        ...
        public ActionResult CheckOut(FormCollection form)
        {
            ...
            { 
                ...
                {
                    // Trả về thông báo lỗi và chuyển hướng về trang ShowCart
                    TempData["ErrorMessage"] = "Giỏ hàng của bạn đang trống! Vui lòng thêm sản phẩm vào giỏ trước khi thanh toán.";
